...
firebase.auth().onAuthStateChanged(function (user) {
    if (user) {
        ...
        $(".margin").hide();
        $("body").append(`
        <div style="margin-top: 3%;" class="page-content-wrapper container">
            <div><b>You have successfully Signed in</b><div>
            <div class="alert alert-success">
                <div>Go to <a href="index.html">Home page</a></div>
                <div>Go to <a href="dashboard.html">Dashboard</a></div>
                <div><a href="dashboard.html">Upload</a> Content</div>
            </div>
        </div>    
        `)
        // ...
